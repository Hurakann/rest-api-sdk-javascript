...
module.exports = function () {
    ...
    function doReq(http_method, uresource, req_data, http_options_param, callback) {
		...
		var resource = '/' + get_default_options().api-version + uresource;
	...
	return {
		...
		userLogin: {
		     ...
		     */
		     loginChangePassword: function(req_data, callback){
				              doReq('POST', '/user/login/change_password', req_data, {}, callback);
		     }
		},
		...
		country:{
		     ...
		     */
		     fetch: function(callback) {
			        doReq('GET', '/geo/country', {}, {}, callback);
		     }
		},
		...
		estate:{
		     ...
		     */
		     fetch: function(req_data, callback) {
			        doReq('GET', '/geo/estate', req_data, {}, callback);
		     }
		},
		...
		town:{
		     ...
		     */
		     fetch: function(req_data, callback) {
			        doReq('GET', '/geo/town', req_data, {}, callback);
		     }
		},
		...
		retail: {
			/**
			 * Get retails assigned to a single object. The required data are:
			 * 
			 * - estimote: The ibeacon device id in the Hover System
			 * - status: It could be active or inactive
			 *
			 * @param req_data object to send
			 * @param callback the function to set the body response
			 */
                        fetch: function(req_data, callback) {
                                   doReq('GET', '/retail', req_data, {}, callback);
                        },
	
			/**
			 * Save retail for a specific ibeacon object previously registered
			 * The required data are:
			 * 
			 * - ad: The ad publishing into html format
			 * - estimote: The ibeacon device id in the Hover System
			 * - status: It could be active or inactive
			 *
                         * @param req_data object to send
			 ...
			 */
                        create: function(req_data, callback) {
                                   doReq('POST', '/retail', req_data, {}, callback);
                        }

			/**
                         * Update retail for a specific ibeacon object previously registered
                         * The required data are:
                         * 
                         * - ad: The ad publishing into html format
                         * - retail_ad_id: Id for the retail
			 * - estimote: The ibeacon device id in the Hover System
                         * - new_status: It could be active or inactive
                         * - actual_status: It could be active or inactive
			 *
                         * @param req_data object to send
                         * @param callback the function to set the body response
                         */
                        create: function(req_data, callback) {
                                   doReq('PUT', '/retail', req_data, {}, callback);
                        }
                }
	};
};
