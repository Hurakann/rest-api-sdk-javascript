...
module.exports = function () {
	...
	return {
		...
		userLogin: {
			...
			/******** Witout testing*********/
			loginRestore: function(req_data, callback){
				doReq('GET', '/v1/user/login/restore', req_data, {}, callback);
			},

			loginReset: function(req_data, callback){
				doReq('POST', '/v1/user/login/reset', req_data, {}, callback);
			},
